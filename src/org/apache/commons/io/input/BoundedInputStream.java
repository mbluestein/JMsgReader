...
public class BoundedInputStream extends InputStream {
	 ...
	 * 
	 * @return <code>true</code> if calling {@link #close()} propagates to the
	 ...
	 *            <code>true</code> if calling {@link #close()} propagates to
	 *            the <code>close()</code> method of the underlying stream or
