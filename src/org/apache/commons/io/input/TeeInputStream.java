 ...
 * from the proxied stream to a given OutputStream. Using {@link #skip(long)} or
 * {@link #mark(int)}/{@link #reset()} on the stream will result on some
...
public class TeeInputStream extends ProxyInputStream {
	 ...
	 * copies all read bytes to the given {@link OutputStream}. The given
